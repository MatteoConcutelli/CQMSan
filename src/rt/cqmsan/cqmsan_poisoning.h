...
#ifndef CQMSAN_POISONING_H
#define CQMSAN_POISONING_H
...
// Detects poisoned memory and retrieves its origin
...
// Sets origin tags for poisoned memory regions
void SetOriginIfPoisoned(__sanitizer::uptr addr, __sanitizer::uptr src_shadow, __sanitizer::uptr size, __sanitizer::u32 src_origin);
...
// quads.
void CopyOrigin(const void *dst, const void *src, __sanitizer::uptr size, __sanitizer::StackTrace*stack);
...
void SetShadow(const void *ptr, __sanitizer::uptr size, u8 value);
